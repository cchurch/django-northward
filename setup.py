...
# Django-Northward
from northward import __version__

tests_require = [
    'Django>=1.7',
    'django-hotrunner>=0.2.2',
    'django-setuptest>=0.1.5',
]
try:
    import argparse
except ImportError:
...
setup(
    name='django-northward',
    version=__version__,
    author='Chris Church',
    author_email='chris@ninemoreminutes.com',
    description='Django app to help switch from South to Django migrations.',
    long_description=open(os.path.join(os.path.dirname(__file__), 'README.md'),
                          'rb').read().decode('utf-8'),
    license='BSD',
    keywords='django south migration',
    url='https://github.com/cchurch/django-northward/',
